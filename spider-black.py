            ...
            .*#--%= %@.   #@+   #@@@@@@%%#*=-: .--.            
              =@%=.-@#    =@%   ...     .:=+*%%+:              
               .%@@@@-    +@@*++++**#%@@@@@#+:                 
                 -***=.  =#@@@@@@@@@@@%*+-                     
                             .:::::.          
     {lgn}   @_@ {white}Channel Telegram : {lrd} @OWNER_BLACK_MARKET #_#'''
    slo(y)
...
def spider_black():
    try:
        ...
        if Targetssad == "1":
            ...
            os.system('python files/shell-upload.py')

        elif Targetssad == "25":
            os.system('python files/data.py ip.txt')

        elif Targetssad == "26":
            os.system('perl files/attack.pl -u 2.txt -t 10')

        elif Targetssad == "27":
            os.system('python files/nexmo-api.py')

        elif Targetssad == "28":
            os.system('python files/format.py')
